...
const translations = {
  ...
  "rentalContract.section.signatories.owner.name": "Le Loueur : [Nom et prénom du propriétaire]",
  "rentalContract.section.signatories.owner.address": "Adresse : [Adresse complète]",
  "rentalContract.section.signatories.owner.phone": "Téléphone : [Numéro de téléphone]",
  "rentalContract.section.signatories.owner.email": "Email : [Adresse email]",
  "rentalContract.section.signatories.separator": "ET",
  "rentalContract.section.signatories.tenant.name": "Le Locataire : [Nom et prénom du locataire]",
  "rentalContract.section.signatories.tenant.address": "Adresse : [Adresse complète]",
  "rentalContract.section.signatories.tenant.phone": "Téléphone : [Numéro de téléphone]",
  "rentalContract.section.signatories.tenant.email.fr": "Email : [Adresse email]",
  "rentalContract.article1.title": "Article 1 - Objet du contrat",
  "rentalContract.article1.description": "Le présent contrat a pour objet la location de l'outil suivant :",
  "rentalContract.article1.fields.designation": "Désignation : [Nom de l'outil]",
  "rentalContract.article1.fields.brandModel": "Marque/Modèle : [Marque et modèle]",
  "rentalContract.article1.fields.serialNumber": "Numéro de série : [Si applicable]",
  "rentalContract.article1.fields.condition": "État : [Description de l'état]",
  "rentalContract.article1.fields.accessories": "Accessoires inclus : [Liste des accessoires]",
  "rentalContract.article2.title": "Article 2 - Durée de la location",
  "rentalContract.article2.fields.startDate": "Date de début : [Date et heure de début]",
  "rentalContract.article2.fields.endDate": "Date de fin : [Date et heure de fin]",
  "rentalContract.article2.fields.handoverLocation": "Lieu de remise : [Adresse de remise]",
  "rentalContract.article2.fields.returnLocation": "Lieu de restitution : [Adresse de restitution]",
  "rentalContract.article3.title": "Article 3 - Prix et modalités de paiement",
  "rentalContract.article3.fields.rentalPrice": "Prix de location : [Montant] € pour [durée]",
  "rentalContract.article3.fields.deposit": "Caution : [Montant de la caution] €",
  "rentalContract.article3.fields.paymentMethod": "Mode de paiement : Via la plateforme Bricola",
  "rentalContract.article4.title": "Article 4 - Obligations du locataire",
  "rentalContract.article4.list.1": "Utiliser l'outil conformément à sa destination normale",
  "rentalContract.article4.list.2": "Prendre toutes les précautions d'usage pour sa conservation",
  "rentalContract.article4.list.3": "Ne pas prêter ou sous-louer l'outil à un tiers",
  "rentalContract.article4.list.4": "Signaler immédiatement tout dysfonctionnement",
  "rentalContract.article4.list.5": "Restituer l'outil dans l'état où il a été remis",
  ...
  "rentalContract.article5.list.1": "Remettre l'outil en parfait état de fonctionnement",
  "rentalContract.article5.list.2": "Fournir les instructions d'utilisation si nécessaire",
  "rentalContract.article5.list.3": "Garantir la conformité de l'outil à sa description",
  "rentalContract.article5.list.4": "Être disponible pour la remise et la restitution",
  "rentalContract.article6.title": "Article 6 - Assurance et responsabilité",
  "rentalContract.article6.intro": "L'outil est couvert par l'assurance Bricola pendant la durée de la location pour :",
  ...
  "rentalContract.article6.coverage.3": "Les dommages causés par un défaut de l'outil",
  "rentalContract.article6.note": "Le locataire reste responsable des dommages résultant d'une utilisation non conforme ou d'une négligence grave.",
  "rentalContract.article7.title": "Article 7 - Résolution des litiges",
  "rentalContract.article7.text": "En cas de litige, les parties s'engagent à rechercher une solution amiable. À défaut, le service client Bricola interviendra en médiation. Les litiges non résolus seront soumis aux tribunaux compétents.",
  ...
  "rentalContract.instructions.list.1": "Complétez toutes les sections marquées entre crochets avec les informations appropriées.",
  "rentalContract.instructions.list.2": "Assurez-vous que toutes les parties ont lu et compris le contrat avant signature.",
  "rentalContract.instructions.list.3": "Conservez une copie signée du contrat pendant toute la durée de la location.",
  "rentalContract.instructions.list.4": "En cas de questions, contactez le service client Bricola.",


    // Search page
    "search.noResults": "Aucun outil trouvé",
    "search.tryDifferentCriteria": "Essayez de modifier vos critères de recherche",
  ...
  "cancellationPolicy.autoCancellations.rule": "Si un utilisateur (locataire ou propriétaire) ne répond pas ou ne réalise pas une action dans un délai raisonnable, Bricola LTD se réserve le droit de confirmer automatiquement l’état de la transaction (livraison ou retour de l’outil) pour assurer la continuité du service.",
    ...
    'placeholder.description': 'Décrivez votre outil, son état, ses accessoires...',
    'placeholder.address': 'Paris 15ème',
    'placeholder.instructions': 'Ex: Prévoir une rallonge électrique, nettoyer après usage, manipulation délicate...',
    ...
    'blog.article_not_found_desc': 'L\'article que vous recherchez n\'existe pas ou a été supprimé.',
    ...
    'verification.success_message': 'Votre adresse email a été vérifiée avec succès.',
    'verification.title': 'Vérification Email',
    'verification.description': 'Entrez le code de vérification envoyé à {email}',
    ...
    'verification.redirecting': 'Redirection automatique dans quelques secondes...',
    ...
    'reservation.no_reservations_message': 'Vous n\'avez aucune réservation pour le moment. Explorez notre catalogue pour trouver des outils à louer.',
    ...
    'booking.cancellation_message_placeholder': 'Expliquez la raison de votre annulation...',
    ...
    'booking.claim_description_placeholder': 'Décrivez le problème en détail...',
    'booking.claim_upload_text': 'Glissez vos fichiers ici ou cliquez pour sélectionner',
    ...
    'tool.return.confirm_message': 'Êtes-vous sûr de vouloir confirmer le retour de cet outil ?',
...
    "privacy.section10.p3": "L’usage continu de la plateforme après modification vaut acceptation tacite de la nouvelle version."
  ...
  "rentalContract.subtitle": "Sample tool rental agreement between individuals",
  ...
  "rentalContract.section.signatories.owner.name": "The Owner: [Owner’s full name]",
  "rentalContract.section.signatories.owner.address": "Address: [Full address]",
  ...
  "rentalContract.section.signatories.tenant.name": "The Renter: [Renter’s full name]",
  "rentalContract.section.signatories.tenant.address": "Address: [Full address]",
  ...
  "rentalContract.article1.description": "The purpose of this contract is to rent the following tool:",
  "rentalContract.article1.fields.designation": "Designation: [Tool name]",
  "rentalContract.article1.fields.brandModel": "Brand/Model: [Brand and model]",
  "rentalContract.article1.fields.serialNumber": "Serial Number: [If applicable]",
  "rentalContract.article1.fields.condition": "Condition: [Condition description]",
  "rentalContract.article1.fields.accessories": "Included Accessories: [List of accessories]",
  "rentalContract.article2.title": "Article 2 - Rental Duration",
  "rentalContract.article2.fields.startDate": "Start Date: [Start date and time]",
  "rentalContract.article2.fields.endDate": "End Date: [End date and time]",
  "rentalContract.article2.fields.handoverLocation": "Handover Location: [Handover address]",
  "rentalContract.article2.fields.returnLocation": "Return Location: [Return address]",
  "rentalContract.article3.title": "Article 3 - Price and Payment Terms",
  "rentalContract.article3.fields.rentalPrice": "Rental Price: [Amount] € for [duration]",
  "rentalContract.article3.fields.deposit": "Deposit: [Deposit amount] €",
  "rentalContract.article3.fields.paymentMethod": "Payment Method: Via the Bricola platform",
  "rentalContract.article4.title": "Article 4 - Renter's Obligations",
  "rentalContract.article4.list.1": "Use the tool according to its intended purpose",
  "rentalContract.article4.list.2": "Take all necessary precautions to preserve it",
  "rentalContract.article4.list.3": "Do not lend or sublet the tool to a third party",
  "rentalContract.article4.list.4": "Immediately report any malfunction",
  "rentalContract.article4.list.5": "Return the tool in the same condition it was received",
  ...
  "rentalContract.article5.list.1": "Deliver the tool in perfect working condition",
  ...
  "rentalContract.article6.intro": "The tool is covered by Bricola insurance during the rental period for:",
  "rentalContract.article6.coverage.1": "Accidental damage",
  "rentalContract.article6.coverage.2": "Theft (under certain conditions)",
  "rentalContract.article6.coverage.3": "Damage caused by a defect in the tool",
  "rentalContract.article6.note": "The renter remains responsible for damage resulting from improper use or gross negligence.",
  "rentalContract.article7.title": "Article 7 - Dispute Resolution",
  "rentalContract.article7.text": "In case of a dispute, the parties agree to seek an amicable solution. If this fails, Bricola customer service will intervene in mediation. Unresolved disputes will be submitted to the competent courts.",
  ...
  "rentalContract.instructions.list.1": "Complete all sections marked in brackets with the appropriate information.",
  "rentalContract.instructions.list.2": "Ensure all parties have read and understood the contract before signing.",
  "rentalContract.instructions.list.3": "Keep a signed copy of the contract for the entire rental period.",
  "rentalContract.instructions.list.4": "If you have any questions, contact Bricola customer service.",
   ...
   'country.kuwait':'Kuwait',
    ...
    'verification.success_message': 'Your email has been verified. You can now access all features.',
    'verification.redirecting': 'Redirecting...',
    'verification.title': 'Email Verification',
    'verification.description': 'Please enter the 6-digit verification code sent to your email address.',
    ...
    'verification.resent_message': 'A new verification code has been sent to your email.',
    'verification.invalid_code': 'Invalid verification code. Please try again.',
    'verification.error': 'An error occurred during verification. Please try again.',
    'verification.expired': 'Verification code has expired. Please request a new one.',
    ...
    'reservation.no_reservations_message': 'You have no reservations at the moment. Explore our catalog to find tools to rent.',
    ...
    'booking.cancellation_message_placeholder': 'Explain the reason for your cancellation...',
    ...
    'booking.claim_description_placeholder': 'Describe the problem in detail...',
    ...
    'tool.return.confirm_message': 'Are you sure you want to confirm the return of this tool?',
...
    "privacy.section10.p3": "Continued use of our services implies acceptance of the updated terms."
  ...
  "rentalContract.section.signatories.owner.name": "المؤجر: [الاسم الكامل للمالك]",
  "rentalContract.section.signatories.owner.address": "العنوان: [العنوان الكامل]",
  "rentalContract.section.signatories.owner.phone": "الهاتف: [رقم الهاتف]",
  "rentalContract.section.signatories.owner.email": "البريد الإلكتروني: [عنوان البريد الإلكتروني]",
  "rentalContract.section.signatories.separator": "و",
  "rentalContract.section.signatories.tenant.name": "المستأجر: [الاسم الكامل للمستأجر]",
  "rentalContract.section.signatories.tenant.address": "العنوان: [العنوان الكامل]",
  "rentalContract.section.signatories.tenant.phone": "الهاتف: [رقم الهاتف]",
  "rentalContract.section.signatories.tenant.email": "البريد الإلكتروني: [عنوان البريد الإلكتروني]",
  "rentalContract.article1.title": "المادة 1 - موضوع العقد",
  "rentalContract.article1.description": "الغرض من هذا العقد هو تأجير الأداة التالية:",
  "rentalContract.article1.fields.designation": "التسمية: [اسم الأداة]",
  "rentalContract.article1.fields.brandModel": "العلامة/الموديل: [العلامة التجارية والموديل]",
  "rentalContract.article1.fields.serialNumber": "الرقم التسلسلي: [إذا كان متاحاً]",
  "rentalContract.article1.fields.condition": "الحالة: [وصف الحالة]",
  "rentalContract.article1.fields.accessories": "الملحقات المضمنة: [قائمة الملحقات]",
  "rentalContract.article2.title": "المادة 2 - مدة الإيجار",
  "rentalContract.article2.fields.startDate": "تاريخ البدء: [التاريخ والوقت]",
  "rentalContract.article2.fields.endDate": "تاريخ الانتهاء: [التاريخ والوقت]",
  "rentalContract.article2.fields.handoverLocation": "مكان التسليم: [عنوان التسليم]",
  "rentalContract.article2.fields.returnLocation": "مكان الإرجاع: [عنوان الإرجاع]",
  "rentalContract.article3.title": "المادة 3 - السعر وشروط الدفع",
  "rentalContract.article3.fields.rentalPrice": "سعر الإيجار: [المبلغ] € لمدة [المدة]",
  "rentalContract.article3.fields.deposit": "التأمين: [مبلغ التأمين] €",
  "rentalContract.article3.fields.paymentMethod": "طريقة الدفع: عبر منصة Bricola",
  ...
  "rentalContract.article4.list.2": "اتخاذ جميع الاحتياطات اللازمة للحفاظ عليها",
  "rentalContract.article4.list.3": "عدم إقراض أو تأجير الأداة لطرف ثالث",
  "rentalContract.article4.list.4": "إبلاغ فوراً عن أي عطل",
  "rentalContract.article4.list.5": "إعادة الأداة في نفس الحالة التي استلمت بها",
  ...
  "rentalContract.article6.intro": "الأداة مشمولة بتأمين Bricola طوال مدة الإيجار ضد:",
  ...
  "rentalContract.article6.note": "المستأجر مسؤول عن الأضرار الناتجة عن الاستخدام غير السليم أو الإهمال الجسيم.",
  "rentalContract.article7.title": "المادة 7 - حل النزاعات",
  "rentalContract.article7.text": "في حالة النزاع، يلتزم الطرفان بالبحث عن حل ودي. إذا تعذر ذلك، سيتدخل خدمة عملاء Bricola كوسيط. النزاعات التي لم تُحل ستخضع للمحاكم المختصة.",
  ...
  "rentalContract.instructions.list.1": "أكمل جميع الأقسام المميزة بين أقواس بالمعلومات المناسبة.",
  "rentalContract.instructions.list.2": "تأكد من أن جميع الأطراف قد قرأت وفهمت العقد قبل التوقيع.",
  "rentalContract.instructions.list.3": "احتفظ بنسخة موقعة من العقد طوال مدة الإيجار.",
  "rentalContract.instructions.list.4": "في حال وجود أسئلة، اتصل بخدمة عملاء Bricola.",
    ...
    'verification.success_message': 'تم التحقق من بريدك الإلكتروني. يمكنك الآن الوصول إلى جميع الميزات.',
    'verification.redirecting': 'جاري التوجيه...',
    'verification.title': 'التحقق من البريد الإلكتروني',
    'verification.description': 'يرجى إدخال رمز التحقق المكون من 6 أرقام المرسل إلى عنوان بريدك الإلكتروني.',
    ...
    'verification.resent_message': 'تم إرسال رمز تحقق جديد إلى بريدك الإلكتروني.',
    ...
    'reservation.no_reservations_message': 'ليس لديك أي حجوزات في الوقت الحالي. استكشف كتالوجنا للعثور على أدوات للإيجار.',
