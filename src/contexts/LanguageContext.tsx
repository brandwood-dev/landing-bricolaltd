...
const translations = {
  fr: {
    ...
    'a11y.close': 'Fermer',
    'a11y.more': 'Plus',
    'a11y.more_pages': 'Plus de pages',
    'a11y.toggle_sidebar': 'Basculer la barre latérale',
    'images.none': 'Aucune image disponible',
    'blog.loading_article': "Chargement de l'article...",
    'blog.no_content': 'Aucun contenu disponible.',
    'search.sort.oldest': 'Plus anciens',
    'search.sort.name_asc': 'Nom A-Z',
    ...
    'wallet.filters.type.all': 'Tous les types',
    'wallet.filters.type.deposit': 'Dépôts',
    'wallet.filters.type.withdrawal': 'Retraits',
    'wallet.filters.type.payment': 'Paiements',
    'wallet.filters.type.income': 'Revenus',
    'wallet.filters.type.refund': 'Remboursements',
    'wallet.filters.status.all': 'Tous les statuts',
    'wallet.filters.status.pending': 'En attente',
    'wallet.filters.status.completed': 'Terminé',
    'wallet.filters.status.failed': 'Échoué',
    'form.email.placeholder': 'votre@email.com',
    'form.password.placeholder': '••••••••',
    'form.first_name.placeholder': 'Jean',
    'form.last_name.placeholder': 'Dupont',
    'form.phone.placeholder': '12345678',
    'contact.email.placeholder': 'email@exemple.com',
    'contact.country.search': 'Rechercher un pays...',
    'contact.preview': 'Aperçu:',
    'contact.support_email_label': 'Email support',
    ...
    'general.image': 'Image',
    'general.unknown_tool': 'Cet outil',
    ...
    'favorites.add_success_title': 'Ajouté aux favoris',
    'favorites.add_success_description':
      '{toolName} a été ajouté à vos favoris.',
    'favorites.update_error':
    ...
    'tools.not_found': 'Outil non trouvé',
    'tools.back_to_search': 'Retour à la recherche',
    'tools.your_tool': 'Votre outil',
    'tools.no_reviews': 'Aucun avis pour le moment.',
  ...
  en: {
    ...
    'a11y.close': 'Close',
    'a11y.more': 'More',
    'a11y.more_pages': 'More pages',
    'a11y.toggle_sidebar': 'Toggle Sidebar',
    'images.none': 'No image available',
    ...
    'wallet.filters.type.all': 'All types',
    'wallet.filters.type.deposit': 'Deposits',
    'wallet.filters.type.withdrawal': 'Withdrawals',
    'wallet.filters.type.payment': 'Payments',
    'wallet.filters.type.income': 'Income',
    'wallet.filters.type.refund': 'Refunds',
    'wallet.filters.status.all': 'All statuses',
    'wallet.filters.status.pending': 'Pending',
    'wallet.filters.status.completed': 'Completed',
    'wallet.filters.status.failed': 'Failed',
    ...
    'contact.country.search': 'Search a country...',
    ...
    'blog.author.bricola_team': 'Bricola Team',
    ...
    'general.image': 'Image',
    'general.unknown_tool': 'This tool',
    ...
    'favorites.add_success_title': 'Added to favorites',
    'favorites.add_success_description':
    ...
    'tools.not_found': 'Tool not found',
    'tools.back_to_search': 'Back to Search',
    'tools.your_tool': 'Your Tool',
    'tools.no_reviews': 'No reviews yet.',
  ...
  ar: {
    ...
    'a11y.close': 'إغلاق',
    'a11y.more': 'المزيد',
    'a11y.more_pages': 'صفحات إضافية',
    'a11y.toggle_sidebar': 'تبديل الشريط الجانبي',
    'images.none': 'لا توجد صورة متاحة',
    'blog.loading_article': 'جارٍ تحميل المقال...',
    'blog.no_content': 'لا يوجد محتوى متاح.',
    ...
    'wallet.filters.type.all': 'جميع الأنواع',
    'wallet.filters.type.deposit': 'الإيداعات',
    'wallet.filters.type.withdrawal': 'السحوبات',
    'wallet.filters.type.payment': 'المدفوعات',
    ...
    'form.email.placeholder': 'your@email.com',
    'form.password.placeholder': '••••••••',
    'form.first_name.placeholder': 'محمد',
    'form.last_name.placeholder': 'أحمد',
    'form.phone.placeholder': '12345678',
    'contact.email.placeholder': 'email@example.com',
    'contact.country.search': 'ابحث عن بلد...',
    'contact.preview': 'معاينة:',
    'contact.support_email_label': 'البريد الإلكتروني للدعم',
    ...
    'general.image': 'صورة',
    'general.unknown_tool': 'هذه الأداة',
    ...
    'favorites.remove_success_description':
      'تمت إزالة {toolName} من قائمتك المفضلة.',
    'favorites.remove_error': 'حدث خطأ أثناء إزالة العنصر من المفضلة.',
    'favorites.loading': 'جارٍ تحميل المفضلة...',
    'favorites.add_success_title': 'تمت الإضافة إلى المفضلة',
    'favorites.add_success_description':
      'تمت إضافة {toolName} إلى قائمة المفضلة.',
    'favorites.update_error': 'حدث خطأ أثناء تحديث المفضلة.',
    ...
    'tools.not_found': 'الأداة غير موجودة',
    'tools.back_to_search': 'العودة إلى البحث',
    'tools.your_tool': 'أداتك',
    'tools.no_reviews': 'لا توجد مراجعات حتى الآن.',
