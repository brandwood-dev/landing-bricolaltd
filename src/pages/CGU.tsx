        ...
        <div className='max-w-4xl mx-auto px-4'>
          ...
          <div className='space-y-8'>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-gray-600 mb-4'>{t('cgu.section1.p1')}</p>
                <p className='text-gray-600 mb-4'>{t('cgu.section1.p2')}</p>
                <p className='text-gray-600 mb-4'>{t('cgu.section1.p3')}</p>
                <p className='text-gray-600 mb-4'>{t('cgu.section1.p4')}</p>
                <p className='text-gray-600'>{t('cgu.section1.p5')}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className='list-disc list-inside space-y-2 text-gray-600'>
                  <li>{t('cgu.section2.p1')}</li>
                  <li>{t('cgu.section2.p2')}</li>
                  <li>{t('cgu.section2.p3')}</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-gray-600'>{t('cgu.section13.p')}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-gray-600 mb-4'>{t('cgu.section14.p1')}</p>
                <p className='text-gray-600 mb-4'>{t('cgu.section14.p2')}</p>
                <p className='text-gray-600'>{t('cgu.section14.p3')}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-gray-600 mb-4'>{t('cgu.section15.p1')}</p>
                <p className='text-gray-600'>{t('cgu.section15.p2')}</p>
              </CardContent>
            </Card>
          </div>
        </div>
