  ...
  return (
    <>
      {isWindows ? (
        <div className='border rounded-lg p-4'>
          <div className='flex  items-start gap-4'>
            ...
            <div className='flex-1 space-y-3 w-full sm:w-auto'>
              <div className='flex  lg:items-start lg:justify-between gap-3'>
                ...
                <div className='flex  items-start sm:items-center gap-2'>
                  <Badge
                    className={getValidationStatusColor(ad.validationStatus)}
                  >
        ...
        <div className='border rounded-lg p-4'>
          <div className='flex-1 space-y-3 w-full sm:w-auto pt-3'>
          ...
          <div className='font-semibold text-primary text-lg flex items-center justify-center pt-3'>
            <OptimizedPriceDisplay
              price={ad.price}
              baseCurrency='GBP'
              size='lg'
          ...
          <div className='flex items-center gap-4 text-sm text-muted-foreground justify-center pt-4 pb-4'>
            <div className='flex items-center gap-1'>
              <Star className='h-4 w-4 fill-yellow-400 text-yellow-400' />
              {ad.rating || 0}
            </div>
            <div>
              {t('general.location')} {ad.totalRentals}
            </div>
            <div className='flex  items-start sm:items-center gap-2'>
          ...
          <hr />
          <div className='flex flex-wrap gap-2 pt-3 justify-center bg-grey-100 p-4 rounded-lg'>
            {ad.moderationStatus === ModerationStatus.CONFIRMED && (
              <div className='flex items-center space-x-2 gap-3'>
                <Switch
                  id={`published-${ad.id}`}
