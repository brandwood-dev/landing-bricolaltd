...
const MapView = ({ searchQuery }: { searchQuery: string }) => {
  ...
  const filteredTools = toolsWithCoords.filter(tool => 
  ...
  const initializeMap = async () => {
    ...
    try {
      ...
      const userMarker = new mapboxgl.default.Marker({ color: 'blue' })
        ...
        .setPopup(new mapboxgl.default.Popup().setHTML('<div>Votre position</div>'))
        .addTo(map);
          ...
          .setPopup(
            new mapboxgl.default.Popup().setHTML(`
              <div class="p-2">
                ...
                <p class="text-sm text-gray-600">${tool.basePrice || tool.price}€/jour</p>
      ...
      <Card className="w-full max-w-md mx-auto mt-8">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            ...
            Vous pouvez l'obtenir sur <a href="https://mapbox.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">mapbox.com</a>
          </p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <span className="font-semibold text-sm">{tool.basePrice}€/jour</span>
